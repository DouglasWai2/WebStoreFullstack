const PrivacyPolicy = () => {
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      A sua privacidade é importante para nós. É política do webstore respeitar
      a sua privacidade em relação a qualquer informação sua que possamos
      coletar no site <a href="https://localhost">webstore</a>, e outros sites
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      ...
      que o webstore oferece no site e com caráter enunciativo, mas não
      limitativo:
    </span>
  </p>
  <ul>
    ...
    <li>
      <span style={{ color: "rgb(68, 68, 68)" }}>
        ...
        (softwares) do webstore, de seus fornecedores ou terceiros, para
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      Esta política é efetiva a partir de&nbsp;1 October 2023 01:18
    </span>
  </p>
</main>
    )
