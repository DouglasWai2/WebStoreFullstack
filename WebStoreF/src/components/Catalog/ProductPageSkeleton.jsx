...
const ProductPageSkeleton = () => {
  return (
    ...
    <article className="shadow-md p-6 w-full max-w-[1440px]">
          ...
          <div className="flex flex-col gap-10 justify-between h-full max-lg:flex-col-reverse">
            ...
            <div className="w-full min-w-[200px]">
              <button
                ...
                className="bg-[#188fa7] w-full h-11 px-2 py-2 mb-2 text-lg
                                rounded-md text-center text-white shadow"                         
              >
              
              </button>
              <button
                className="px-6 h-6 bg-[#ade6f1] text-center w-full rounded-md"
              >
      ...
      <section className="w-[auto] mt-10" id="Product-description">
