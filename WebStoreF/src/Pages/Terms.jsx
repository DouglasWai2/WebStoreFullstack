const Terms = () => {
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      Ao acessar ao site <a href="https://localhost">webstore</a>, concorda em
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      ...
      (informações ou software) no site webstore , apenas para visualização
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      ...
      restrições e poderá ser rescindida por webstore a qualquer momento. Ao
  ...
  <ol>
    <li>
      <span style={{ color: "rgb(68, 68, 68)" }}>
        Os materiais no site da webstore são fornecidos 'como estão'. webstore
    ...
    <li>
      <span style={{ color: "rgb(68, 68, 68)" }}>
        Além disso, o webstore não garante ou faz qualquer representação
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      Em nenhum caso o webstore ou seus fornecedores serão responsáveis ​​por
      ...
      incapacidade de usar os materiais em webstore, mesmo que webstore ou um
      representante autorizado da webstore tenha sido notificado oralmente ou
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      Os materiais exibidos no site da webstore podem incluir erros técnicos,
      tipográficos ou fotográficos. webstore não garante que qualquer material
      em seu site seja preciso, completo ou atual. webstore pode fazer
      alterações nos materiais contidos em seu site a qualquer momento, sem
      aviso prévio. No entanto, webstore não se compromete a atualizar os
      materiais.
    </span>
  </p>
  <h2>
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      O webstore não analisou todos os sites vinculados ao seu site e não é
      responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer
      link não implica endosso por webstore do site. O uso de qualquer site
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      O webstore pode revisar estes termos de serviço do site a qualquer
  ...
  <p>
    <span style={{ color: "rgb(68, 68, 68)" }}>
      ...
      do webstore e você se submete irrevogavelmente à jurisdição exclusiva dos
